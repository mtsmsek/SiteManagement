...
using ValidationException = SiteManagement.Application.CrossCuttingConcerns.Exceptions.Types.ValidationException;

namespace SiteManagement.Application.Pipelines.Validation;

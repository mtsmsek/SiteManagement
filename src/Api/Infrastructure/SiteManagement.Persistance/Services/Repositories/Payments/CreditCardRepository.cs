...
{
    public class CreditCardRepository : EfAsyncRepository<CreditCard, SiteManagementPaymentsContext>
    {
        public CreditCardRepository(SiteManagementPaymentsContext dbContext) : base(dbContext)
        {
        }
    }
}
